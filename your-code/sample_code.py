...
Original file is located at
    https://colab.research.google.com/drive/1mPMUxzsJxNMofKKI9h5XOB8Mx6--6vrY
"""
...
def living_room():
    ...
    There is a dining table and 3 boxes where you can choose between 3 colors : blue, yellow and red.
    ...
    if color == "yellow":
      ...
      if 'key D' in game_state['keys_collected']:
        print('Congrats you can open the Door D')

      else:

        print('You have missed the Key D , You have to go back.')
